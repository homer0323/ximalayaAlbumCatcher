# 喜马拉雅专辑抓取
你可以用这个工具来得到一个或多个主播所有在喜马拉雅上的专辑的信息。

通过这种方式，我，一个鱼航员，做了一个可以帮助用户知道每一个奇喵宇宙出品于喜马拉雅的专辑的连载情况的工具。 
p.s. 你可以找到源代码和打包过的程序在“qimiaoyuzhouAlbumCatcher”分支中。



# ximalayaAlbumCatcher
You can use this tool to get the information of all the albums on Ximalaya by one or more anchors. 
